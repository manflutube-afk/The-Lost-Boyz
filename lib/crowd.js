...
/*
 * Out of five mics, or nothing. Anything that is not a whole number in range is
 * treated as no rating rather than rounded into one somebody did not give.
 */
export function cleanMics(value) {
